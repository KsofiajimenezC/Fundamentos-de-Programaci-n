...
#### 1.1 Análisis
Primero se inserta un inicio, para después colocar una salida de datos que imprima el texto "Sofía" para terminar el programa con un fin.
...
#### 3.1 Análisis
Empezar con inicio, se agrega un proceso para darle el valor de "Sofi" a la       variable nom, después se pone un mensaje para que muestre "Hola ",nom para terminar con un fin.
